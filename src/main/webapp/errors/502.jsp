			...
			<div class="col-lg-8 col-lg-offset-2 text-center">
				<div class="error-template">
					...
					<div class="error-details">
						...
						<br>
						<p>Sorry, The HTTP 502 Bad Gateway server error response code
							indicates that the server, while acting as a gateway or proxy,
							received an invalid response from the upstream server.</p>
						<br>
						<p>A Gateway might refer to different things in networking and
							a 502 error is usually not something you can fix, but requires a
