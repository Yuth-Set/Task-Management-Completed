...
<body>
					...
					<li><c:if
							...
							<form id="logoutForm" method="POST"
								...
								Welcome ${pageContext.request.userPrincipal.name} | <a
									onclick="document.forms['logoutForm'].submit()">Logout</a> <input
				...
				<div class="row row-offcanvas">
					...
					<div class="col-xs-12">
						<div class="jumbotron">
							...
							<p>Take it easy...</p>
							<p class="lead">
								<a href="new-task" class="btn btn-lg btn-primary">Create new
									task</a> <a href="all-tasks" class="btn btn-lg btn-info">All
									The Tasks Listed</a>
							</p>
						</div>
					</div>
			...
			<c:when test="${mode == 'MODE_TASKS'}">
				<div class="col-xs-12" id="taskDiv">
					...
					<div class="table-responsive">
						<table id="task_pagin"
							class="table table-bordered table-responsive" cellspacing="0"
							width="100%">
							<thead>
								<tr class="bg-head">
									<th>ID</th>
								...
								<c:forEach var="task" items="${tasks}">
									<tr>
										...
										<td class="text-center"><a
											href="delete-task?id=${task.id}"><span
												class="glyphicon glyphicon-remove-circle"></span></a> <a
											href="update-task?id=${task.id}"><span
			...
			<c:when test="${mode == 'MODE_NEW' || mode == 'MODE_UPDATE'}">
				<div class="col-xs-12">
					...
					<form class="form-horizontal" method="post"
						action="save-task?${_csrf.parameterName}=${_csrf.token}">
						<input type="hidden" name="id" value="${task.id}" />
						<div class="form-group">
							<label class="control-label col-md-3">Name</label>
							<div class="col-md-9">
								<input type="text" class="form-control" name="name"
									value="${task.name}" required /> <input type="hidden"
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" name="description"
									value="${task.description}" required /> <input type="hidden"
									name="${_csrf.parameterName}" value="${_csrf.token}" />
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-md-3">Finished</label> <input
								type="radio" class="col-sm-1" name="finished" value="true" />
	...
	<script src="${contextPath}/resources/js/paginate.js"></script>
	<script src="${contextPath}/resources/js/xss_prevent.js"></script>
</body>
</html>
